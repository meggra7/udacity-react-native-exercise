    ...
    <SafeAreaView>
      <ScrollView>
        <View style={styles.container}>
          ...
          <TouchableOpacity
            onPress={() => console.log("Create Story button pressed")}
          >
          ...
          {storyReady && (
            <View>
              ...
              <Text>
                ...
                early and continuous delivery of {adjective2}
                software.
              </Text>
              ...
              <Text>
                {verb1} working software {adjective5}, from a{periodOfTime1} to
                a {periodOfTime2}, with a preference to the shorter timescale.
              </Text>
            </View>
          )}
        </View>
