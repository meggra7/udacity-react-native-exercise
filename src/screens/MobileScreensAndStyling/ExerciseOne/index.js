  ...
  return (
    <View>
      {navigationType === "stack" && (
        <NavigationBar
          previousScreen="Mobile Screens And Styling Exercise Three Pop"
          nextScreen="Mobile Screens And Styling Exercise Two Push"
        />
      )}
      <ScrollView contentContainerStyle={styles.scrollViewContainer}>
        ...
        <Text style={{ margin: 20 }}>
          Cupcake ipsum dolor sit amet. Lemon drops candy canes chupa chups
          cotton candy cupcake cotton candy. Soufflé pudding lollipop donut
          powder biscuit lemon drops pie biscuit. Chocolate topping jelly-o
          liquorice cake dessert croissant. Cake biscuit pastry chocolate bar
          sesame snaps tootsie roll lemon drops gingerbread sweet. Topping
          brownie pie icing candy canes wafer liquorice pudding jujubes. Cake
          cookie gummi bears apple pie marshmallow lemon drops lemon drops
          ...
          chupa chups cupcake cake.{"\n\n"}Jelly-o gummies gummi bears sugar
          plum donut muffin chocolate cake chocolate. Lollipop cookie tart
          shortbread chupa chups. Chocolate bar brownie jujubes shortbread
          fruitcake fruitcake tart cake. Pudding gummi bears pudding icing
          caramels apple pie chupa chups. Jujubes danish muffin tiramisu jelly-o
          macaroon sugar plum pudding icing. Liquorice icing sweet roll
          marshmallow cake.{"\n\n"}Cake caramels chupa chups tiramisu croissant
          liquorice chupa chups toffee. Candy canes gummi bears dragée lemon
          drops biscuit. Cake sesame snaps ice cream toffee apple pie. Icing
